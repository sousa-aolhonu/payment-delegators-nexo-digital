...
def calculate_additional_columns(delegators, earnings):
    try:
        ...
        print(f"{Fore.GREEN}[Success]{Style.RESET_ALL} Total Delegated HP: {Fore.YELLOW}{total_hp}{Style.RESET_ALL}")
        logging.info(f"Total Delegated HP: {total_hp}")
        ...
        logging.info("Percentage of each delegator's HP calculated.")
        ...
        print(f"{Fore.GREEN}[Success]{Style.RESET_ALL} HIVE Deduction calculated with multiplier {Fore.YELLOW}{hive_deduction_multiplier}{Style.RESET_ALL}")
        logging.info(f"HIVE Deduction calculated with multiplier {hive_deduction_multiplier}")
        ...
        print(f"{Fore.GREEN}[Success]{Style.RESET_ALL} {token_name} Payment calculated with fixed price {Fore.YELLOW}{token_fixed_price}{Style.RESET_ALL}")
        logging.info(f"{token_name} Payment calculated with fixed price {token_fixed_price}")

        df["TxID"] = "Pending"
        print(f"{Fore.GREEN}[Success]{Style.RESET_ALL} TxID column initialized with 'Pending' status.")
        logging.info("TxID column initialized with 'Pending' status.")
